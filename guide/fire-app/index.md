...
1. Fireタブレットのホーム画面で、**「アプリストア」**（Amazonアプリストア）を開きます。
2. 上の検索まどに **「オンラインデイサービス長老大学」** と入力して検索します。
3. アプリが見つかったら **「入手」**（または「ダウンロード」）を押すと、自動で入ります。
4. 終わったら **「開く」**、または次回からは**ホーム画面のアイコン**から起動できます。
